/** 
 * Copyright 2007 Alberto Cuesta Ca�ada, licensed under the Academic Free License.
...
public class MasterEvaluator extends SimpleEvaluator{
    ...
    public void evaluatePopulation(final EvolutionState state){
    	...
    	Address target;
    	Individual[] inds = state.population.subpops.get(0).individuals.toArray(new Individual[state.population.subpops.get(0).individuals.size()]);
